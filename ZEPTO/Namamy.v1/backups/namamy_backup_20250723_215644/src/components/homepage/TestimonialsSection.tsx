...
const testimonials = [
  {
    ...
    rating: 5,
    image: 'https://images.unsplash.com/photo-1494790108755-2616b7e1a9b2?q=80&w=150&auto=format&fit=crop',
      ...
      <div className="container mx-auto container-padding">
        ...
        >
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 relative overflow-hidden">
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br from-makhana-200 to-makhana-300 rounded-full blur-xl opacity-50"></div>
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-gradient-to-br from-primary-200 to-primary-300 rounded-full blur-xl opacity-40"></div>
          </div>
        </motion.div>
          ...
          {testimonials.slice(0, 3).map((testimonial, index) => (
            <div
              ...
              className={`bg-white rounded-2xl p-6 shadow-lg border border-gray-100 cursor-pointer transition-all duration-300 hover:shadow-xl ${
                index === currentIndex ? 'ring-2 ring-makhana-300' : ''
              }`}
              onClick={() => goToSlide(index)}
            >
