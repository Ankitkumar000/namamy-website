...
export function HeroSection({ locale }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-makhana-50 via-white to-primary-50">
      {/* Background Pattern */}
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-makhana-200 rounded-full blur-xl animate-float opacity-60"></div>
      <div className="absolute top-40 right-20 w-32 h-32 bg-primary-200 rounded-full blur-xl animate-float opacity-40" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-40 left-20 w-24 h-24 bg-accent-200 rounded-full blur-xl animate-float opacity-50" style={{ animationDelay: '4s' }}></div>
