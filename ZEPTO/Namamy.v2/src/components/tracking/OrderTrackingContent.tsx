...
const mockOrderData: OrderDetails = {
  ...
  shippingAddress: {
    name: 'John Doe',
    address: 'House no-263, Police Station Road, Sabour',
    city: 'Bhagalpur',
    state: 'Bihar',
    pincode: '813210',
  ...
  trackingEvents: [
    ...
    },
    {
      ...
      location: 'Namamy Fulfillment Center, Bhagalpur',
    ...
    },
    {
      ...
      location: 'Bhagalpur Sorting Facility',
    ...
    },
    {
      ...
      location: 'Local Delivery Hub, Bhagalpur',
