...
const faqData: FAQItem[] = [
  ...
  // Shipping Questions
  {
    ...
    answer: 'Yes! We offer free shipping on all orders above ₹500 across India. For orders below ₹500, standard shipping charges of ₹50-100 apply depending on your location. Express delivery options are also available.',
    icon: Truck,
  },
  {
    id: 'shipping-2',
  ...
  },
  {
    ...
    answer: 'Contact our customer service team at returns@namamy.com or call +91 7261071570, 70912 60484 within 7 days of delivery. Provide your order number and reason for return. We\'ll guide you through the return process and provide a return label if needed.',
    icon: RotateCcw,
  },
  {
    id: 'returns-3',
  ...
  // Customer Support
  {
    ...
    answer: 'You can reach us via Email: support@namamy.com, Phone: +91 7261071570, 70912 60484, WhatsApp: +91 7261071570, 70912 60484, or through the contact form on our website. Our support hours are Monday-Saturday, 9AM-6PM IST.',
    icon: Phone,
  },
  {
    id: 'support-2',
    ...
    answer: 'Yes! We offer attractive discounts for bulk orders (50+ units), corporate gifting, and wholesale purchases. Please contact our sales team at bulk@namamy.com or call +91 7261071570, 70912 60484 for custom pricing and solutions.',
    icon: Phone,
  },
  {
    id: 'support-3',
          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onClick={() => window.open('https://wa.me/917261071570', '_blank')}
              >
                <Phone className="w-4 h-4 mr-2" />
                WhatsApp Us
              </Button>
